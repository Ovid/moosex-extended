# PODNAME: MooseX::Extreme Tutorial
# ABSTRACT: Work-in-progress tutorial for MooseX::Extreme

=head1 CONVERTING FROM MOOSE

For most sane codebases, converting from L<Moose> to L<MooseX::Extreme> is as
simple as C<< s/Moose/MooseX::Extreme/ >>. We I<try> to be
...
classes if they use C<MooseX::Extreme>:
