package MooseX::SafeDefaults::Role;

# ABSTRACT: MooseX::SafeDefaults roles
...
Similar to L<MooseX::SafeDefaults>, this provides C<field> and C<param> to the role.
...
L<MooseX::SafeDefaults::Role>, you get a warning. This makes maintenance easier
